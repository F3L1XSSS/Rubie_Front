...
function Signin() {
        ...
        <MDBCol col='12'>
          ...
          <MDBCard className='bg-dark text-white my-5 mx-auto' style={{borderRadius: '1rem', maxWidth: '400px'}}>
            ...
            <h2 className="fw-bold mb-2 text-uppercase">Вхід</h2>
              ...
              <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-white' label='Введіть пароль' id='formControlLg' type='password' size="lg"/>
  ...
  <li><a class="social-icon-telegram" href="https://web.telegram.org/k/" title="..." target="_blank" rel="noopener"></a></li>
              ...
              <div>
                <p className="mb-0">Нємає аккаунту? <a href="/singup" class="text-white-50 fw-bold">Зареєстроватися</a></p>
              </div>
            </MDBCardBody>
          </MDBCard>
